@php
    ...
    $texts = [
        'fr' => [
            'page_title' => 'Ajouter un conseil - Administration',
            'header_title' => 'Ajouter un conseil pratique',
            'header_subtitle' => 'Créez un conseil destiné aux parents et aux familles.',

            'conseil_title' => 'Titre du conseil',
            'conseil_title_placeholder' => 'Exemple : Mieux communiquer avec son enfant',
            ...
            'content_placeholder' => 'Rédigez ici le conseil complet...',
            ...
            'save' => 'Enregistrer le conseil',
            'back' => 'Retour',
        ],
        'mg' => [
            'page_title' => 'Hampiditra torohevitra - Administration',
            'header_title' => 'Hampiditra torohevitra',
            'header_subtitle' => 'Mamoròna torohevitra ho an’ny ray aman-dreny sy ny fianakaviana.',

            'conseil_title' => 'Lohatenin’ny torohevitra',
            'conseil_title_placeholder' => 'Ohatra : Fifandraisana tsara amin’ny zanaka',
            ...
            'content_placeholder' => 'Soraty eto ny torohevitra feno...',
...
<div class="container-fluid">
    ...
    <div class="col-md-6 mb-3">
        ...
        <input
            ...
            class="form-control"
            value="{{ old('title_fr') }}"
            placeholder="Exemple : Mieux communiquer avec son enfant"
            required
        >
    </div>
    ...
    <div class="col-md-6 mb-3">
        ...
        <input
            ...
            class="form-control"
            value="{{ old('title_mg') }}"
            placeholder="Ohatra : Fifandraisana tsara amin’ny zanaka"
        >
    </div>
</div>
...
<div class="row">
    <div class="col-md-6 mb-3">
        ...
        <textarea
            ...
            class="form-control"
            rows="9"
            placeholder="Rédigez ici le conseil complet..."
            required
    ...
    <div class="col-md-6 mb-3">
        ...
        <textarea
            ...
            class="form-control"
            rows="9"
            placeholder="Soraty eto ny torohevitra feno..."
