@php
    ...
    $texts = [
        'fr' => [
            'page_title' => 'Modifier un module - Administration',
            'header_title' => 'Modifier le module éducatif',
            'header_subtitle' => 'Mettez à jour les informations et le contenu du module.',
        ...
        'mg' => [
            'page_title' => 'Hanova module - Administration',
            'header_title' => 'Hanova module fanabeazana',
            'header_subtitle' => 'Havaozy ny mombamomba sy ny votoatin’ny module.',
...
<div class="container-fluid">
    <div class="row">
        ...
        <main class="col-md-10 p-4 admin-main">
            ...
            <div class="admin-page-header">
                <div>
                    <h1>{{ $t['header_title'] ?? 'Modifier le module éducatif' }}</h1>
                    <p>{{ $t['header_subtitle'] ?? 'Mise à jour du module éducatif.' }}</p>
                </div>

            @include('admin.partials.header-actions', [
                'backUrl' => route('admin.modules.index')
                ])
            </div>
                                    ...
                                    <select name="category_id" class="form-select">
                                        ...
                                        @foreach($categories as $category)
                                            <option value="{{ $category->id }}"
                                                {{ old('category_id', $module->category_id) == $category->id ? 'selected' : '' }}>
                                                {{ $category->name }}
                                            </option>
                                        @endforeach
                                    </select>
    ...
    <div class="col-md-6 mb-3">
        ...
        <input
            ...
            name="title_fr"
            class="form-control"
            value="{{ old('title_fr', $module->title_fr ?? $module->title) }}"
            required
        >
    </div>
    ...
    <div class="col-md-6 mb-3">
        ...
        <input
            ...
            name="title_mg"
            class="form-control"
            value="{{ old('title_mg', $module->title_mg) }}"
        >
    </div>
</div>
...
<div class="row">
    <div class="col-md-6 mb-3">
        ...
        <textarea
            ...
            class="form-control"
            rows="3"
        >{{ old('description_fr', $module->description_fr ?? $module->description) }}</textarea>
    </div>
    ...
    <div class="col-md-6 mb-3">
        ...
        <textarea
            ...
            class="form-control"
            rows="3"
        >{{ old('description_mg', $module->description_mg) }}</textarea>
    </div>
</div>
...
<div class="row">
    <div class="col-md-6 mb-3">
        ...
        <textarea
            ...
            rows="9"
            required
        >{{ old('content_fr', $module->content_fr ?? $module->content) }}</textarea>
    </div>
    ...
    <div class="col-md-6 mb-3">
        ...
        <textarea
            ...
            class="form-control"
            rows="9"
        >{{ old('content_mg', $module->content_mg) }}</textarea>
    </div>
</div>
